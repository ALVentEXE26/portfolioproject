      ...
      <PageAnimation delay={0}>
        <section className="py-20">
          <h1 className="mb-6 text-5xl font-bold tracking-tight text-[#E5E7EB]">
            Hi, I'm <span className="text-[#3B82F6]">John Alfred Ventura</span>
          </h1>
          <p className="mb-8 max-w-2xl text-lg text-[#9CA3AF]">
            ...
            I create optimized, accessible experiences with modern technologies. I am also known as ALVentEXE on GitHub.
          </p>
